...
//    }
    ...
    public String searchCuocThi(
        ...
        List<CuocThi> results = new ArrayList<>();
        ...
        try {
            ...
            {
                results.addAll(cuocThiService.searchByDiaDiemThi(diaDiemThi));
                ...
                if (startDate != null && endDate != null) {
                    results.addAll(cuocThiService.searchByNgayThi(startDate, endDate));
                }
            }
